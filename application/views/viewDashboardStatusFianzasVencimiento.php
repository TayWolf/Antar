<div class="container">
    <div class="row">
        <div class="col s12">
            <div class="col s4"><h4 class="header">Fianzas / garantías por vencer</h4></div>
        </div>
    ...
    <script>
        function visualizarTabla(idVigencia, idPago)
        {
            ...
            * */
            ...
            loadUrl('CrudDashboard/visualizarTablaStatusFianzaVencimiento/<?=$diasTolerancia?>/<?=urlencode($fechaInicial).'/'.urlencode($fechaFinal)?>/'+idVigencia+'/'+idPago+'/<?=$idEmpresaInterna?>', "tablaTarjeta")
        }
