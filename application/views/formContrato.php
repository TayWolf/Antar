<div class="container">
    ...
    <div class="row">
        ...
        <div class="col s12">
            ...
            <div class="col s4"><h4 class="header">Nuevo documento</h4></div>
    ...
    <script>
...

        {
           ...
           e.preventDefault();
            ...
            $.post('<?=base_url('index.php/CrudContratos/nuevoContrato')?>',

                {nombre: $("#name").val(), [csrfName]: csrfHash },

                function(response){

                    swal('Éxito', 'Se guardó el nuevo documento', 'success');
                    loadUrl('CrudContratos');
                }
