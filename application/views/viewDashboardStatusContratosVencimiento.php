<div class="container">
    <div class="row">
        <div class="col s12">
            <div class="col s4"><h4 class="header">Contratos por vencer</h4></div>
        </div>
    ...
    <script>
        ...
        {
            loadUrl('CrudDashboard/visualizarTablaStatusContratoVencimiento/<?=$diasTolerancia?>/'+idStatus, "tablaTarjeta")
        }
