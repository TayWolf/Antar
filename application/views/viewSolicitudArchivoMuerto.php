...
<div class="container">
    ...
    <div class="row">
        ...
        <div align="center">
            ...
            <a class='dropdown-trigger btn' href="#" onclick="loadUrl('CrudArchivoMuerto')" data-target='dropdown1'>Regresar</a>
                        ...
                        <?=form_open('', 'class="col s12" id="formulario" enctype="multipart/form-data"')?>
                            ...
                            <div class="row">
                                ...
                                <div class="col s12 m10">
                                    ...
                                    <input name="nomenclatura" id="nomenclatura" type="text">
...

                {
...

                    {
...

                        {
                            ...
                            var base=('<?=base_url("index.php/CrudArchivoMuerto/descargarArchivoDetalles/".$idContratoProyecto)?>');
