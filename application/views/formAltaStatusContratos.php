<div class="container">
    ...
    <div class="row">
        ...
        <div class="col s12">
            ...
            <div class="col s12"><h4 class="header">Nuevo status</h4></div>
                        ...
                        <?=form_open('', 'class="col s12" id="formulario"')?>
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12">
                                    <input id="etiqueta" name="etiqueta" type="text" required>
                                    <label for="etiqueta">Etiqueta del status</label>
                                </div>
                                ...
                                <div class="col s12 m6 l4">
                                    ...
                                    <div class="gradient-45deg-amber-amber padding-5 medium-small"
                                        ...
                                        <input name="color" type="radio" id="color0" checked  class="with-gap" value="gradient-45deg-amber-amber"><label for="color0">Escoger</label>
                                    </div>
                                    <br>
    ...
    <script>
        ...
        $("#formulario").on('submit', function (e) {
            ...
            $.post("<?=base_url('index.php/CrudStatusContratos/insertarNuevoStatus')?>",

                {clase: $("input[name=color]:checked").val(), etiqueta: $("#etiqueta").val(), [csrfName]: csrfHash },
